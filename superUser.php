<?php
    //load xml database
    session_start();
    if(!isset($_SESSION['usernameAdmin'])) header("Location: loginInterface.php");
	...
	<body id="super-user">
		...
		<section class="home-section">
			<div class="nav1">
				...
				<div class="title_nav" id="titlenav">Interface super user</div>
				<div class="dropdown">
					<button
						id="language"
			...
			<div class="container">
				...
				<button type="button" class="btn btn-primary ajouter_user" id="ajouterUser" data-toggle="modal" data-target="#exampleModalCenter">Ajouter user</button>
				...
				<table id="myTable" class="listeProf table table-hover caption-top table-bordered table-striped table-responsive-md">
					...
					<thead class="thead-dark">
						<tr>
							<th id="loginProf">Login</th>
							<th id="nomProf">Nom</th>
							<th id="prenomProf">Prenom</th>
							<th id="motDePasseProf">Mot de passe</th>
							<th id="actionsProf">Actions</th>
						</tr>
					</thead>
					<tbody>
						<?php 
				...
				<table id="myTable_cord" class="none listeProf table table-hover caption-top table-bordered table-striped table-responsive-md">
					...
					<thead class="thead-dark">
						<tr>
							<th id="loginCor">Login</th>
							<th id="nomCor">Nom</th>
							<th id="prenomCor">Prenom</th>
							<th id="motDePasseCor">Mot de passe</th>
							<th id="actionsCor">Actions</th>
						</tr>
					</thead>
					<tbody>
						<?php 
				...
				<table id="myTable_chef_dept" class="none listeProf table table-hover caption-top table-bordered table-striped table-responsive-md">
					...
					<thead class="thead-dark">
						<tr>
							<th id="loginChef">Login</th>
							<th id="nomChef">Nom</th>
							<th id="prenomChef">Prenom</th>
							<th id="motDePasseChef">Mot de passe</th>
							<th id="actionsChef">Actions</th>
						</tr>
					</thead>
					<tbody>
						<?php 
				...
				<table id="myTable_agent_scholarite" class="none listeProf table table-hover caption-top table-bordered table-striped table-responsive-md">
					...
					<thead class="thead-dark">
						<tr>
							<th id="loginAg">Login</th>
							<th id="nomAg">Nom</th>
							<th id="prenomAg">Prenom</th>
							<th id="motDePasseAg">Mot de passe</th>
							<th id="actionsAg">Actions</th>
						</tr>
					</thead>
					<tbody>
						<?php 
				...
				<!-- ////////////////////////// GESTION MATIERE /////////////////////////////////////////////// -->
				<button type="button" class="btn btn-primary ajouter_mat none" data-toggle="modal" data-target="#exampleModalCenter12" id="ajouterMat">Ajouter matiere</button>
				<table id="myTable_list_mat" class="none listeProf table table-hover caption-top table-bordered table-striped table-responsive-md">
					...
					<thead class="thead-dark">
						<tr>
							<th id="matiereMat">Matiere</th>
							<th id="moduleMat">Module</th>
							<th id="filiereMat">Filiere</th>
							<th id="actionsMat">Actions</th>
						</tr>
					</thead>
					<tbody>
						<?php 
				...
				<button type="button" class="btn btn-primary ajouter_mat none" data-toggle="modal" data-target="#exampleModalCenter13" id="ajouterAcc">Ajouter access</button>
				<table id="myTable_matiere" class="none listeProf table table-hover caption-top table-bordered table-striped table-responsive-md">
					...
					<thead class="thead-dark">
						<tr>
							<th id="utilisateurAcc">Utilisateur</th>
							<th id="matiereAcc">Matiere</th>
							<th id="actionsAcc">Actions</th>
						</tr>
					</thead>
					<tbody>
						<?php 
				...
				<!-- ////////////////////// PERMISSIONS ////////////////////////////////////////////////// -->
				<button type="button" class="btn btn-primary ajouter_perm none" data-toggle="modal" data-target="#exampleModalCenter14" id="ajouterPer">Ajouter permission</button>
				...
				<button type="button" class="btn btn-primary ajouter_perm_role none" data-toggle="modal" data-target="#exampleModalCenter16" id="ajouterPerRole">Ajouter permission_role </button>
				<table id="myTable_permission_role" class="none listeProf table table-hover caption-top table-bordered table-striped table-responsive-md">
					<caption id="listPerRole">
						Liste des permissions_roles
					</caption>
					<thead class="thead-dark">
						<tr>
							<th id="rolePer">Role</th>
							<th id="permissionRole">Permission</th>
							<th id="actionsPerRole">Actions</th>
						</tr>
					</thead>
					<tbody>
						<?php 
